...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/formulaic-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11831&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/formulaic-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `formulaic` can be installed with:

```
conda install formulaic
```

It is possible to list all of the versions of `formulaic` available on your platform with:
